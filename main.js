...
document.addEventListener('DOMContentLoaded', function () {
    const cardData = [
        ...
        {title: 'Жук Дмитро', subtitle: '17', content: 'Чому програмісти так люблять маленький код? Бо чим менше коду, тим більше часу на каву!', imageSrc: '/images/people/pic6.png'},
        ...
        {title: 'Малий Андрій', subtitle: '18', content: 'Знаєте де буде 80% отих з 4 корпусу... В центрі на касі', imageSrc: '/images/people/pic14.jpg'},
